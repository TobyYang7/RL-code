...
>>>>>>> 70e8c2116d876aac32cbe0727280332bd13b32e1
    ...
    model = make_model('cuda:0', nb_block=2, in_channels=2, K=3, nb_chev_filter=3, nb_time_filter=3, time_strides=3, adj_mx=adj, num_for_predict=args.out_len, len_input=args.in_len, num_of_vertices=50)
